...
class Logger:
    ...
    def sucess(message: str) -> None:
        """Args: message (str): mensagem de sucesso a ser emitida"""
        logging.basicConfig(
    ...
    def info(message: str) -> None:
        """Args: message (str): mensagem de informação a ser emitida"""
        logging.basicConfig(
            format="%(asctime)s - %(message)s",
            datefmt="%d-%b-%y %H:%M:%S",
            level=logging.INFO,
    ...
    def warning(message: str) -> None:
        """Args: message (str): mensagem de aviso a ser emitida """
        logging.basicConfig(
            format="%(asctime)s - %(message)s",
            datefmt="%d-%b-%y %H:%M:%S",
    ...
    def error(message: str) -> None:
        """Args: message (str): mensagem de erro a ser emitida """
        logging.basicConfig(
            format="%(asctime)s - %(message)s",
            datefmt="%d-%b-%y %H:%M:%S",
            level=logging.ERROR,
